...
class SigininSplashScreen extends StatefulWidget {
  const SigininSplashScreen({super.key});

  @override
  State<SigininSplashScreen> createState() => _SigininSplashScreenState();
}

class _SigininSplashScreenState extends State<SigininSplashScreen> {
  @override
  void initState() {
    super.initState();
     // 3초 후에 홈 화면으로 이동합니다.
