        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Deleted Accounts Management button
              _buildAdminMenuButton(
                context: context,
                icon: Icons.delete_sweep_outlined,
                title: 'Deleted Accounts',
                description: 'View deleted user accounts and deletion reasons',
                color: const Color(0xFFEF4444),
                onTap: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => const DeletedAccountsAdminPage(),
                    ),
                  );
                },
                widthRatio: widthRatio,
