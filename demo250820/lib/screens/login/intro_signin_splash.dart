...
import '../community/initial_profile/profile_information_screen.dart';
  ...
  void initState() {
    ...
    Timer(const Duration(seconds: 3), () {
      if (mounted) { // 위젯이 여전히 화면에 있는지 확인합니다.
        Navigator.of(context).pushReplacementNamed('/'); // 전화번호 인증 -> <conditional> 아이디 & 비밀번호 -> <conditional> 회원가입완료 ->  <conditional> 카테고리선택 -> <conditional> 실팻 고르기 -> 로그인 완료
      }
    });
  }
