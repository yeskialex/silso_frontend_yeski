...
// Widget that displays background image responsively based on screen ratio
class ResponsiveBackground extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Background image settings based on screen ratio
          ...
          child: backgroundAssetPath != null
              ? SvgPicture.asset(
                  ...
                  placeholderBuilder: (context) => Container(
                    color: const Color(0xFF3F3329), // Default background color
                  ),
                )
              : Container(
  ...
  // Determine optimal BoxFit based on screen ratio
  ...
  // Adjust overlay color intensity based on screen ratio
...
// Background image management utility by screen size
